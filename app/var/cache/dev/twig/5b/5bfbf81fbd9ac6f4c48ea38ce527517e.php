 ...
 <ul>
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["music"]) {
            // line 12
            yield "        <li>";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["music"], "auteur", [], "any", false, false, false, 12), "html", null, true);
            yield " </li> 
    ";
        }
...
";
    ...
    {
        return array (  123 => 14,  114 => 12,  110 => 11,  104 => 8,  87 => 5,  64 => 3,  41 => 1,);
    }
